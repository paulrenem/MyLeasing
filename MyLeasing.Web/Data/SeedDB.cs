using MyLeasing.Web.Data.Entityes;
using System;
...
namespace MyLeasing.Web.Data
{
    public class SeedDb
    {
        ...
        private async Task CheckPropertyTypesAsync()
        {
            ...
            {
                _context.PropertyTypes.Add(new Entityes.PropertyType { Name = "Apartamento" });
                _context.PropertyTypes.Add(new Entityes.PropertyType { Name = "Casa" });
                _context.PropertyTypes.Add(new Entityes.PropertyType { Name = "Negocio" });
